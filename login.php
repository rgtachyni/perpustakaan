...
if (isset($_POST["login"])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM admin WHERE  adminid ='$username'");
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-black my-4">Login E-Library</h3>
                                </div>
                                <div class="card-body">
                                    <form class="user" method="POST" action="login.php">
                                        <div class=" form-group">
                                            <input class="form-control py-4 mb-4" id="username" type="text" name="username" placeholder="AdminId" />
                                        </div>
                                        <div class="form-group">
